...
/*namespace HM0905
{
    public partial class PhieuNhapHang : Form
    {
        ...
        {
            string sql;
            sql = "SELECT a. MaSP, b.TenSP, b.DVT, b.VAT, a.SL, b.DGNhap,a.ThanhTien FROM tblChitietPhieuNhapHang AS a, tblSanPham AS b WHERE a.MaPhieuNhapHang = N'" + txtmaphieu.Text + "' AND a.MaSP=b.MaSP";
        ...
        private void dataGridViewPNH_CellContentClick_1(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if ((MessageBox.Show("Bạn có chắc chắn muốn xóa không?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes))
            {
                ...
                SoLuongxoa = Convert.ToSingle(dataGridViewPNH.CurrentRow.Cells["SL"].Value.ToString());
        ...
        private void btnxoa_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql = "SELECT MaSP,SL FROM tblChitietPhieuNhapHang WHERE MaPhieuNhapHang = N'" + txtmaphieu.Text + "'";
        ...
        private void btnluu_Click(object sender, EventArgs e)
        {
            ...
            sql = "INSERT INTO tblChitietPhieuNhapHang(MaPhieuNhapHang,MaSP,DVT, SL,DGNhap, VAT,ThanhTien) VALUES(N'" + txtmaphieu.Text.Trim() + "',N'" + cbbmasp.SelectedValue + "',N'"+ txtdvt.Text +"'," + txtsoluong.Text + "," + txtdongia.Text + "," + txtvat.Text + "," + txtthanhtien.Text + ")";
            Functions.RunSql(sql);
            LoadDataGridView();
        ...
        private void btnin_Click(object sender, EventArgs e)
        {
           ...
           DataTable tblThongtinHD, tblThongtinHang;
            ...
            sql = "SELECT b. MaSP, b.TenSP,b.DVT, b.VAT, a.SL, b.DGNhap, a.ThanhTien " +
        ...
        private void InitializeComponent()
        {
            ...
            this.Load += new System.EventHandler(this.PhieuNhapHang_Load_1);
