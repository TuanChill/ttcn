...
namespace ttcn
{
    public partial class PXK : Form
    {
        ...
        private void btn_luu_Click(object sender, EventArgs e)
        {
            ...
            if(txt_ln.Text == "")
            {
                MessageBox.Show("Bạn phải nhập loại phiếu", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txt_ln.Focus();
                return;
            }
            ...
            try
            {
                ...
                foreach (DataRow r in DataTable.Rows)
                {
                    ...
                    // convert soluong, thanh tien sang decimal
                    decimal soluong = Decimal.Parse(r["SoLuong"].ToString());
